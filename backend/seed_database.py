...
DATABASE_NAME = os.getenv("DATABASE_NAME", "easylife_auth")
...
async def seed_database():
    ...
    # ROLES
    # ============================================
    all_domains = ["sales", "inventory", "hr", "finance", "operations", "analytics"]
    ...
    # ============================================
    users = [
        {"email": "admin@example.com", "username": "admin", "full_name": "System Administrator", "name": "System Administrator", "password_hash": password_hash, "roles": ["super-admin"], "groups": ["administrators"], "customers": ["customer-001", "customer-002", "customer-003", "customer-004", "customer-005"], "is_active": True, "is_super_admin": True, "email_verified": True, "created_at": now, "updated_at": now, "last_login": None},
        {"email": "manager@example.com", "username": "manager", "full_name": "John Manager", "name": "John Manager", "password_hash": password_hash, "roles": ["admin"], "groups": ["managers"], "customers": ["customer-001", "customer-002"], "is_active": True, "is_super_admin": False, "email_verified": True, "created_at": now, "updated_at": now, "last_login": None},
        {"email": "editor@example.com", "username": "editor", "full_name": "Jane Editor", "name": "Jane Editor", "password_hash": password_hash, "roles": ["editor"], "groups": ["analysts"], "customers": ["customer-001"], "is_active": True, "is_super_admin": False, "email_verified": True, "created_at": now, "updated_at": now, "last_login": None},
        {"email": "viewer@example.com", "username": "viewer", "full_name": "Bob Viewer", "name": "Bob Viewer", "password_hash": password_hash, "roles": ["viewer"], "groups": ["sales-team"], "customers": ["customer-001"], "is_active": True, "is_super_admin": False, "email_verified": True, "created_at": now, "updated_at": now, "last_login": None},
        {"email": "sales@example.com", "username": "salesuser", "full_name": "Sales User", "name": "Sales User", "password_hash": password_hash, "roles": ["sales-manager"], "groups": ["sales-team"], "customers": ["customer-001", "customer-003"], "is_active": True, "is_super_admin": False, "email_verified": True, "created_at": now, "updated_at": now, "last_login": None},
        {"email": "inactive@example.com", "username": "inactive", "full_name": "Inactive User", "name": "Inactive User", "password_hash": password_hash, "roles": ["viewer"], "groups": [], "customers": [], "is_active": False, "is_super_admin": False, "email_verified": False, "created_at": now, "updated_at": now, "last_login": None},
    ]
    ...
    # ============================================
    scenarios = [
        {"key": "sales-overview", "name": "Sales Overview", "description": "Overview of sales performance", "dataDomain": "sales", "domainKey": "sales", "path": "/sales/overview", "icon": "chart-pie", "order": 1, "status": "active", "defaultSelected": True, "type": "custom", "subDomains": [], "created_at": now, "updated_at": now},
        {"key": "sales-by-region", "name": "Sales by Region", "description": "Regional sales breakdown", "dataDomain": "sales", "domainKey": "sales", "path": "/sales/by-region", "icon": "map", "order": 2, "status": "active", "defaultSelected": False, "type": "custom", "subDomains": [], "created_at": now, "updated_at": now},
        {"key": "sales-trends", "name": "Sales Trends", "description": "Historical sales trends", "dataDomain": "sales", "domainKey": "sales", "path": "/sales/trends", "icon": "trending-up", "order": 3, "status": "active", "defaultSelected": False, "type": "custom", "subDomains": [], "created_at": now, "updated_at": now},
        {"key": "inventory-stock", "name": "Stock Levels", "description": "Current inventory stock levels", "dataDomain": "inventory", "domainKey": "inventory", "path": "/inventory/stock", "icon": "package", "order": 1, "status": "active", "defaultSelected": True, "type": "custom", "subDomains": [], "created_at": now, "updated_at": now},
        {"key": "inventory-movement", "name": "Stock Movement", "description": "Inventory movement tracking", "dataDomain": "inventory", "domainKey": "inventory", "path": "/inventory/movement", "icon": "truck", "order": 2, "status": "active", "defaultSelected": False, "type": "custom", "subDomains": [], "created_at": now, "updated_at": now},
        {"key": "hr-employees", "name": "Employee Directory", "description": "Employee information", "dataDomain": "hr", "domainKey": "hr", "path": "/hr/employees", "icon": "users", "order": 1, "status": "active", "defaultSelected": True, "type": "custom", "subDomains": [], "created_at": now, "updated_at": now},
        {"key": "hr-attendance", "name": "Attendance", "description": "Employee attendance tracking", "dataDomain": "hr", "domainKey": "hr", "path": "/hr/attendance", "icon": "clock", "order": 2, "status": "active", "defaultSelected": False, "type": "custom", "subDomains": [], "created_at": now, "updated_at": now},
        {"key": "finance-reports", "name": "Financial Reports", "description": "Financial statements and reports", "dataDomain": "finance", "domainKey": "finance", "path": "/finance/reports", "icon": "file-text", "order": 1, "status": "active", "defaultSelected": True, "type": "custom", "subDomains": [], "created_at": now, "updated_at": now},
        {"key": "finance-budgets", "name": "Budget Management", "description": "Budget planning and tracking", "dataDomain": "finance", "domainKey": "finance", "path": "/finance/budgets", "icon": "calculator", "order": 2, "status": "active", "defaultSelected": False, "type": "custom", "subDomains": [], "created_at": now, "updated_at": now},
        {"key": "analytics-dashboard", "name": "Analytics Dashboard", "description": "Business intelligence dashboard", "dataDomain": "analytics", "domainKey": "analytics", "path": "/analytics/dashboard", "icon": "activity", "order": 1, "status": "active", "defaultSelected": True, "type": "custom", "subDomains": [], "created_at": now, "updated_at": now},
    ]
        ...
        },
        {
            ...
            "data": {
                ...
                "widgets": {
                    ...
                    "grid": {"layout": {"columns": ["emp_id", "name", "department", "position", "status"], "headers": ["ID", "Name", "Department", "Position", "Status"], "ispaginated": True, "defaultSize": 25}, "actions": {"rowActions": {"renderAs": "button", "attributes": [], "events": []}}},
                    "pagination": [{"name": "limit", "dataKey": "limit", "displayName": "Page Size", "index": 0, "visible": True}]
                }
            },
            "created_at": now,
    ...
    configurations = [
        ...
        {"config_id": "config-lookup-001", "key": "region-codes", "type": "lookup-data", "queries": {}, "logics": {}, "operations": {}, "lookups": {"NA": "North America", "EU": "Europe", "APAC": "Asia Pacific", "LATAM": "Latin America", "MEA": "Middle East & Africa"}, "data": {}, "row_add_stp": now, "row_update_stp": now},
        {"config_id": "config-app-001", "key": "app-settings", "type": "snapshot-data", "queries": {}, "logics": {}, "operations": {}, "lookups": {}, "data": {"theme": "light", "language": "en", "timezone": "UTC", "date_format": "YYYY-MM-DD", "currency": "USD", "pagination_size": 25}, "row_add_stp": now, "row_update_stp": now},
        {"config_id": "config-lookup-pages", "key": "ui-schema-pages", "type": "lookup-data", "queries": {}, "logics": {}, "operations": {}, "lookups": {"CUST_SEARCH": "Customer Search", "ORDER_MGMT": "Order Management", "INV_DASHBOARD": "Inventory Dashboard", "RPT_SALES": "Sales Report", "RPT_FINANCE": "Finance Report", "USR_PROFILE": "User Profile", "ADM_SETTINGS": "Admin Settings", "ADM_USERS": "User Management"}, "data": {}, "row_add_stp": now, "row_update_stp": now},
        {"config_id": "config-lookup-components", "key": "ui-schema-components", "type": "lookup-data", "queries": {}, "logics": {}, "operations": {}, "lookups": {"data-grid": "Data Grid", "search-form": "Search Form", "detail-view": "Detail View", "summary-card": "Summary Card", "filter-panel": "Filter Panel", "chart-widget": "Chart Widget", "export-panel": "Export Panel", "action-bar": "Action Bar"}, "data": {}, "row_add_stp": now, "row_update_stp": now},
    ]
    ...
    audit_logs = [
        ...
        {"action": "login", "entity_type": "auth", "entity_id": "manager@example.com", "user_id": "manager@example.com", "user_email": "manager@example.com", "changes": {}, "timestamp": one_day_ago},
        {"action": "create", "entity_type": "groups", "entity_id": "test-group", "user_id": "admin@example.com", "user_email": "admin@example.com", "changes": {"name": {"new": "Test Group"}}, "timestamp": one_day_ago},
        {"action": "login", "entity_type": "auth", "entity_id": "admin@example.com", "user_id": "admin@example.com", "user_email": "admin@example.com", "changes": {}, "timestamp": two_days_ago},
        {"action": "login", "entity_type": "auth", "entity_id": "editor@example.com", "user_id": "editor@example.com", "user_email": "editor@example.com", "changes": {}, "timestamp": two_days_ago},
        {"action": "create", "entity_type": "domains", "entity_id": "test-domain", "user_id": "admin@example.com", "user_email": "admin@example.com", "changes": {"key": {"new": "test-domain"}}, "timestamp": two_days_ago},
        {"action": "login", "entity_type": "auth", "entity_id": "admin@example.com", "user_id": "admin@example.com", "user_email": "admin@example.com", "changes": {}, "timestamp": three_days_ago},
        {"action": "create", "entity_type": "scenarios", "entity_id": "test-scenario", "user_id": "editor@example.com", "user_email": "editor@example.com", "changes": {"name": {"new": "Test Scenario"}}, "timestamp": three_days_ago},
        {"action": "login", "entity_type": "auth", "entity_id": "manager@example.com", "user_id": "manager@example.com", "user_email": "manager@example.com", "changes": {}, "timestamp": four_days_ago},
        {"action": "login", "entity_type": "auth", "entity_id": "sales@example.com", "user_id": "sales@example.com", "user_email": "sales@example.com", "changes": {}, "timestamp": four_days_ago},
        {"action": "login", "entity_type": "auth", "entity_id": "admin@example.com", "user_id": "admin@example.com", "user_email": "admin@example.com", "changes": {}, "timestamp": five_days_ago},
        {"action": "login", "entity_type": "auth", "entity_id": "viewer@example.com", "user_id": "viewer@example.com", "user_email": "viewer@example.com", "changes": {}, "timestamp": six_days_ago},
    ]
    ...
    try:
        ...
        await db.roles.create_index("status")
        ...
        await db.permissions.create_index("module")
        ...
        await db.domains.create_index("status")
        await db.domain_scenarios.create_index("key", unique=True)
        await db.domain_scenarios.create_index("domainKey")
        await db.domain_scenarios.create_index("status")
        await db.playboards.create_index("key", unique=True)
        await db.playboards.create_index("scenarioKey")
        await db.playboards.create_index("status")
        await db.configurations.create_index("config_id", unique=True)
        await db.configurations.create_index("key")
        await db.configurations.create_index("type")
    ...
    print(f"  - domain_scenarios: {len(scenarios)}")
    print(f"  - playboards: {len(playboards)}")
