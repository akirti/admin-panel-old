...
class ValidationService:
    ...
    def validate_scenario_data(data: Dict[str, Any]) -> List[str]:
        """Validate scenario creation/update data."""
        errors = validate_domain_data(data)  # Same base validation

        try:
            ValidationService.validate_required(data.get("domainKey"), "domainKey")
            ValidationService.validate_key(data.get("domainKey", ""), "domainKey")
        except ValidationError as e:
            errors.append(str(e))
...
def validate_domain_data(data: Dict[str, Any]) -> List[str]:
    return ValidationService.validate_domain_data(data)


def validate_scenario_data(data: Dict[str, Any]) -> List[str]:
    return ValidationService.validate_scenario_data(data)
