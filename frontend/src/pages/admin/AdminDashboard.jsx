    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Link to={isSuperAdmin() ? '/admin/roles' : '#'} className="card p-4 hover:shadow-md transition-all">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-content-muted">Total Roles</p>
              <p className="text-2xl font-bold text-content">{stats?.total_roles || 0}</p>
            </div>
        ...
        <Link to={isSuperAdmin() ? '/admin/groups' : '#'} className="card p-4 hover:shadow-md transition-all">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-content-muted">Total Groups</p>
              <p className="text-2xl font-bold text-content">{stats?.total_groups || 0}</p>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Link to={isSuperAdmin() ? '/admin/domains' : '/management/domains'} className="card p-4 hover:shadow-md transition-all">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-content-muted">Domains</p>
              <p className="text-2xl font-bold text-content">{stats?.total_domains || 0}</p>
            </div>
        ...
        <Link to={isSuperAdmin() ? '/admin/scenarios' : '#'} className="card p-4 hover:shadow-md transition-all">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-content-muted">Scenarios</p>
              <p className="text-2xl font-bold text-content">{stats?.total_scenarios || 0}</p>
            </div>
        ...
        <Link to={isSuperAdmin() ? '/admin/playboards' : '#'} className="card p-4 hover:shadow-md transition-all">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-content-muted">Playboards</p>
              <p className="text-2xl font-bold text-content">{stats?.total_playboards || 0}</p>
            </div>
        ...
        <Link to={isSuperAdmin() ? '/admin/configurations' : '#'} className="card p-4 hover:shadow-md transition-all">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-content-muted">Configurations</p>
              <p className="text-2xl font-bold text-content">{stats?.total_configurations || 0}</p>
            </div>
                  ...
                  <div key={user.user_email} className="flex items-center justify-between py-2 border-b border-edge-light last:border-0">
                    <div className="flex items-center">
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center mr-3 ${
                        ...
                        index === 1 ? 'bg-surface-hover text-content-secondary' :
