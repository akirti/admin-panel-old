      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            {domain?.description && (
              <p className="text-sm text-neutral-500 mt-1">{domain.description}</p>
            )}
          </div>
        </div>
      ...
      {filteredScenarios.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredScenarios.map((scenario) => (
            ...
            >
              <div className="p-5">
                <h3 className="text-lg font-semibold text-neutral-800 group-hover:text-red-600 transition-colors mb-2">
                  {scenario.name}
                </h3>
