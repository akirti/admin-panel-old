...
// Switch to the admin_panel database
...
try {
  ...
  { key: 'sales-overview', name: 'Sales Overview', description: 'Overview of sales performance', dataDomain: 'sales', domainKey: 'sales', path: '/sales/overview', icon: 'chart-pie', order: 1, status: 'active', defaultSelected: true, type: 'custom', created_at: new Date(), updated_at: new Date() },
  { key: 'sales-by-region', name: 'Sales by Region', description: 'Regional sales breakdown', dataDomain: 'sales', domainKey: 'sales', path: '/sales/by-region', icon: 'map', order: 2, status: 'active', defaultSelected: false, type: 'custom', created_at: new Date(), updated_at: new Date() },
  { key: 'sales-trends', name: 'Sales Trends', description: 'Historical sales trends', dataDomain: 'sales', domainKey: 'sales', path: '/sales/trends', icon: 'trending-up', order: 3, status: 'active', defaultSelected: false, type: 'custom', created_at: new Date(), updated_at: new Date() },
  { key: 'inventory-stock', name: 'Stock Levels', description: 'Current inventory stock levels', dataDomain: 'inventory', domainKey: 'inventory', path: '/inventory/stock', icon: 'package', order: 1, status: 'active', defaultSelected: true, type: 'custom', created_at: new Date(), updated_at: new Date() },
  { key: 'inventory-movement', name: 'Stock Movement', description: 'Inventory movement tracking', dataDomain: 'inventory', domainKey: 'inventory', path: '/inventory/movement', icon: 'truck', order: 2, status: 'active', defaultSelected: false, type: 'custom', created_at: new Date(), updated_at: new Date() },
  { key: 'hr-employees', name: 'Employee Directory', description: 'Employee information', dataDomain: 'hr', domainKey: 'hr', path: '/hr/employees', icon: 'users', order: 1, status: 'active', defaultSelected: true, type: 'custom', created_at: new Date(), updated_at: new Date() },
  { key: 'hr-attendance', name: 'Attendance', description: 'Employee attendance tracking', dataDomain: 'hr', domainKey: 'hr', path: '/hr/attendance', icon: 'clock', order: 2, status: 'active', defaultSelected: false, type: 'custom', created_at: new Date(), updated_at: new Date() },
  { key: 'finance-reports', name: 'Financial Reports', description: 'Financial statements and reports', dataDomain: 'finance', domainKey: 'finance', path: '/finance/reports', icon: 'file-text', order: 1, status: 'active', defaultSelected: true, type: 'custom', created_at: new Date(), updated_at: new Date() },
  { key: 'finance-budgets', name: 'Budget Management', description: 'Budget planning and tracking', dataDomain: 'finance', domainKey: 'finance', path: '/finance/budgets', icon: 'calculator', order: 2, status: 'active', defaultSelected: false, type: 'custom', created_at: new Date(), updated_at: new Date() },
  { key: 'analytics-dashboard', name: 'Analytics Dashboard', description: 'Business intelligence dashboard', dataDomain: 'analytics', domainKey: 'analytics', path: '/analytics/dashboard', icon: 'activity', order: 1, status: 'active', defaultSelected: true, type: 'custom', created_at: new Date(), updated_at: new Date() }
]);
...
db.audit_logs.insertMany([
  ...
  { action: 'update', entity_type: 'users', entity_id: 'editor@example.com', user_id: 'admin@example.com', user_email: 'admin@example.com', changes: { status: { old: 'inactive', new: 'active' } }, timestamp: oneDayAgo },
  { action: 'delete', entity_type: 'permissions', entity_id: 'test.permission', user_id: 'admin@example.com', user_email: 'admin@example.com', changes: {}, timestamp: oneDayAgo },
  ...
  { action: 'update', entity_type: 'customers', entity_id: 'customer-001', user_id: 'manager@example.com', user_email: 'manager@example.com', changes: { status: { old: 'inactive', new: 'active' } }, timestamp: twoDaysAgo },
  ...
  { action: 'update', entity_type: 'playboards', entity_id: 'sales-overview-board', user_id: 'editor@example.com', user_email: 'editor@example.com', changes: { status: { old: 'inactive', new: 'active' } }, timestamp: threeDaysAgo },
  ...
  { action: 'create', entity_type: 'configurations', entity_id: 'config-test-001', user_id: 'admin@example.com', user_email: 'admin@example.com', changes: { type: { new: 'process-config' } }, timestamp: fourDaysAgo },
  { action: 'update', entity_type: 'roles', entity_id: 'viewer', user_id: 'admin@example.com', user_email: 'admin@example.com', changes: { permissions: { old: 10, new: 12 } }, timestamp: fourDaysAgo },
  ...
  { action: 'create', entity_type: 'users', entity_id: 'temp@example.com', user_id: 'admin@example.com', user_email: 'admin@example.com', changes: { email: { new: 'temp@example.com' } }, timestamp: fiveDaysAgo },
  { action: 'delete', entity_type: 'users', entity_id: 'temp@example.com', user_id: 'admin@example.com', user_email: 'admin@example.com', changes: {}, timestamp: fiveDaysAgo },
  ...
  { action: 'update', entity_type: 'groups', entity_id: 'analysts', user_id: 'admin@example.com', user_email: 'admin@example.com', changes: { domains: { old: 2, new: 3 } }, timestamp: sixDaysAgo },
  { action: 'create', entity_type: 'permissions', entity_id: 'custom.permission', user_id: 'admin@example.com', user_email: 'admin@example.com', changes: { module: { new: 'custom' } }, timestamp: sixDaysAgo }
]);
...
db.domain_scenarios.createIndex({ dataDomain: 1 });
